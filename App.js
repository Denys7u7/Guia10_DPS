...
class PantallaInicio extends React.Component {
  ...
  Entrar() {
    if (!!this.state.usuario && !!this.state.contrasena) {
      fetch(
        "https://dps-guia10.000webhostapp.com/php/apiusuario.php?comando=autenticar&usuario=" +
          this.state.usuario +
          "&contrasena=" +
...
class listarProductos extends React.Component {
  ...
  cargarRegistros() {
    console.log("Prueba");
    fetch("https://dps-guia10.000webhostapp.com/php/api.php?comando=listar", {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaDetalle extends React.Component {
  ...
  Eliminar() {
    fetch(
      "https://dps-guia10.000webhostapp.com/php/api.php?comando=eliminar&id=" +
        this.state.id,
      {
        method: "GET",
      }
